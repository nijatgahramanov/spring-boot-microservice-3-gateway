...
@Component
public class JwtProvider implements JwtProviderInter {
    ...
    public JwtProvider(@Value("${authentication.jwt.public-key}") String jwtPrivateKeyStr,
                       @Value("${authentication.jwt.private-key}") String jwtPublicKeyStr) {
        ...
        try {
            ...
            throw new RuntimeException("Invalid key specification", ex);
        }
    }
